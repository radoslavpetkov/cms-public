...
//check if loged
if(!isset($_SESSION['user']['loged']) OR !$_SESSION['user']['loged']==true){
    // Render HTML output 
...
$upload_dir = array( 
 ...
 $server_path = SERVER_ROOT;
// Allowed image properties  - defined in config.php
...
if(isset($_FILES['upload']) && strlen($_FILES['upload']['name']) > 1) { 
    ...
    // File upload path 
    $f_name = setFName(SERVER_ROOT . $upload_dir, F_NAME, ".$type", 0); 
